...
mongo.connect(config.get("mongoURI"),  { useNewUrlParser: true }, { useUnifiedTopology: true }, cors(), (err, db) => {
	router.post("/", (req, res) => {
		...
		let gatherPassedDownData = req.app.get("uuid-data");
			...
			const { message, email, timestamp, firstName, uuid, lastName, self, jobHistory, category, hourly, workerCount, description, phoneNumber, streetAddress, city, zipCode } = req.body;
